...
Insert into Department values(4,'Electrical Engineering','India')
Insert into Department values(5,'Chemical Engineering','India')
Insert into Department values(6,'Sound Engineering','Russia')
Insert into Department values(7,'','Russia')
